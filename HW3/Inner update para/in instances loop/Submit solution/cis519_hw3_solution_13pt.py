...
class LogisticRegressionAdagrad:
    ...
    def __init__(self, alpha = 5, regLambda=0.01, regNorm=2, epsilon=0.0001, maxNumIters = 10000, initTheta = None):
        '''
        Constructor
        Arguments:
        	alpha is the learning rate
    ...
    def gradientDescent(self, X, y, theta):     # the X should be preprocessed
        ...
        for iter in range(self.maxNumIters):
            ...
            theta = theta - np.multiply(curr_alpha, self.computeGradient(theta, X_shuffled, y_shuffled, self.regLambda)) # curr_grad d*1 compGrad d*1
            # if iter_break == 1:
            #     break
